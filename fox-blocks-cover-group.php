<?php
/**
 * Plugin Name: Fox Blocks Cover Group
 * Plugin URI: https://github.com/samikeijonen/fox-blocks-cover-group/
 * Description: Fox Blocks Cover Group.
 * Version: 1.0.0
 * Author: Sami Keijonen
 * License: MIT
 * Text Domain: fox-blocks-cover-group-cover-group
...
final class Plugin {
	...
	public function i18n() {
		load_plugin_textdomain( 'fox-blocks-cover-group', false, trailingslashit( dirname( plugin_basename( __FILE__ ) ) ) . 'languages' );
	}
}
